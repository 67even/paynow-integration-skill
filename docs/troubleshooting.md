...
| Hash mismatch on a button/link notification | Wrong algorithm | Notifications use **key+value**, not values alone. See [`hashing.md`](../hashing/). |
...
| Test payment page won't complete | Same as above | See [`testing-and-golive.md`](../testing/). |
...
This page is generated from [`paynow-skills/paynow-integration/references/troubleshooting.md`](https://github.com/67even/paynow-integration-skill/blob/main/paynow-skills/paynow-integration/references/troubleshooting.md) in the skill. Spotted something wrong? [Open an issue](https://github.com/67even/paynow-integration-skill/issues).
